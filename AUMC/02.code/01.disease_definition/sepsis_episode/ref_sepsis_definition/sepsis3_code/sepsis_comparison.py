...
combined_diagnoses = pd.read_csv(
    inputs.additional_file_path + 'combined_diagnoses.csv', encoding='latin-1')

sofa = pd.read_csv(inputs.additional_file_path + 'sofa.csv', encoding='latin-1')
sepsis = pd.read_csv(inputs.additional_file_path + 'sepsis3.csv', encoding='latin-1')
